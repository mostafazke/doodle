...
function App() {
  ...
  return (
    <React.Fragment>
              ...
              <Grid container spacing={2} justify="center">
                ...
                <Grid item>
                  <FormControl className={classes.formControl}>
                    ...
                    <Select labelId="years-label" id="years" value={year} onChange={handleYears}>
        ...
        <Container className={classes.cardGrid} maxWidth="lg">
          ...
          <Grid container spacing={4}>
            {[]
              ...
              .sort((a, b) => (a.run_date_array[2] > b.run_date_array[2] ? 1 : -1))
              .map(doodle => (
                <Grid item key={doodle.name} xs={12} sm={6} md={4}>
                  <Card className={classes.card}>
                    <CardMedia
                      onClick={() => handleLightBox(true, doodle.url || doodle.high_res_url)}
      ...
      {/* End footer*/}
      {isOpen && <Lightbox mainSrc={photo} onCloseRequest={() => handleLightBox(false)} />}
    </React.Fragment>
  );
}
